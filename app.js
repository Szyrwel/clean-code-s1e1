...
var incompleteTaskHolder=document.getElementById("incomplete-tasks");//ul of #incomple-tetasks
...
var createNewTaskElement=function(taskString){
    ...
    editInput.classList.add('list__item_text-input')
    //button.edit
    ...
    label.classList.add('task', 'list__item_label');
